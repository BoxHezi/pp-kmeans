...
#ifndef SECRET_SHARING_MULTIPLICATION_PARTY_H
#define SECRET_SHARING_MULTIPLICATION_PARTY_H

#include "party.h"

namespace emp {
    template<typename IO>
    class MultiplicationParty : public Party<IO> {
    private:
    ...
    public:
        ...
        MultiplicationParty(int party, IO * io_Alice, IO * io_Bob, int input)
        ...
        void compute() override {
            ...
            if(this->party == ALICE) {
                ...
                // <e>_0 = <a>_0 - <x>_0
                local_e = this->mod(this->local_share - x);
                // <f>_0 = <b>_0 - <y>_0
                local_f = this->mod(this->remote_share - y);
                ...
                // <e>_1 = <a>_1 - <x>_1
                local_e = this->mod(this->remote_share - x);
                // <f>_1 = <b>_1 - <y>_1
                local_f = this->mod(this->local_share - y);
    ...
    template<typename IO>
    inline MultiplicationParty<NetIO> setup_multiplication_party(int party, IO *io_Alice, IO *io_Bob, int i) {
        return MultiplicationParty<IO>(party, io_Alice, io_Bob, i);
    }
}

#endif //SECRET_SHARING_MULTIPLICATION_PARTY_H
